...
<button id="btn">输出值</button><br/>

数值:<input type="text" name="value" id="value"> <button id="write">写入</button>
...
$("#output").val(data.name+":"+data.value);	
...
$("#write").click(function()   {
	...
	var para=$("#para").val();
	var value=$("#value").val();
	var datas={"parameter":para,"value":value};
	//var datas={"parameter":para};
	$.ajax({
	url:"/ssh1/lock_writeOutPutParameter",
	type:"post",
	 data:datas, 
